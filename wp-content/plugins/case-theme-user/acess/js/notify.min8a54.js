(function (e) {
  ...
  var t =
    ...
    v = function (t, i) {
      ...
      i.classes &&
        ...
        o && ((i.cssElem = m(o)), i.cssElem.attr("id", "notify-" + i.name));
      var u = {},
        a = e(i.html);
  ...
  (L.prototype.loadHTML = function () {
    ...
    (L.prototype.setElementPosition = function () {
      ...
      t.call(u, _) >= 0
        ? (N(p, "left", C(O, h, y)), r && N(r, "left", C(O, i, m)))
        : t.call(o, _) >= 0 &&
          (N(p, "top", C(O, c, d)), r && N(r, "top", C(O, i, v))),
    ...
    (e.fn[n] = function (t, n) {
      return (
        e(this).each(function () {
          var i;
          return (
            (i = T(e(this)).data(r)), i ? i.run(t, n) : new L(e(this), t, n)
          );
        }),
        this
      );
