(function ($) {
  ...
  $(document).ready(function () {
    ...
    /* Newsletter */
    $(".widget_newsletterwidget, form.newsletter, form.tnp-subscription").each(
      function () {
    ...
    $(".wpcf7-form").each(function () {
      ...
      $(this)
        .find(".ct-range-result")
        .val(range_currency + $(this).find(".ct-range-slider").slider("value"));
    });
  ...
  function consultio_col_offset() {
    setTimeout(function () {
      ...
      if (window_width > 1200) {
        ...
        if (window_width > 1200) {
          $(
            "body:not(.rtl) .ct-column-offset-left > .elementor-column-wrap > .elementor-widget-wrap",
          ).css("padding-left", w_vc_row_lg_medium + "px");
          $(
            "body:not(.rtl) .ct-column-offset-right > .elementor-column-wrap > .elementor-widget-wrap",
          ).css("padding-right", w_vc_row_lg_medium + "px");

          $(
            ".rtl .ct-column-offset-left > .elementor-column-wrap > .elementor-widget-wrap",
          ).css("padding-right", w_vc_row_lg_medium + "px");
          $(
            ".rtl .ct-column-offset-right > .elementor-column-wrap > .elementor-widget-wrap",
          ).css("padding-left", w_vc_row_lg_medium + "px");
        }
      }
    }, 10);
