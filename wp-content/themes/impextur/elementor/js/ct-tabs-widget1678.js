(function ($) {
  ...
  var WidgetCTTabsHandler = function ($scope, $) {
    $scope
      .find(".ct-tabs .ct-tabs-title .ct-tab-title")
      .on("click", function (e) {
        e.preventDefault();
  ...
  $(window).on("elementor/frontend/init", function () {
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/ct_tabs.default",
      WidgetCTTabsHandler,
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/ct_tab_template.default",
      WidgetCTTabsHandler,
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/ct_tab_banner.default",
      WidgetCTTabsHandler,
    );
  });
})(jQuery);
