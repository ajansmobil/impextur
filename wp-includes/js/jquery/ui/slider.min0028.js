    ...
    _mouseCapture: function (e) {
      ...
      return (
        ...
        this.handles.each(function (e) {
          ...
          (t < s ||
            (s === t &&
              (e === l._lastChangedValue || l.values(e) === r.min))) &&
            ((s = t), (a = o(this)), (n = e));
        }),
        !1 !== this._start(e, n) &&
      ...
      this._hasMultipleValues()
              ...
              !0 === l.options.range &&
                ("horizontal" === l.orientation
                  ? (0 === e &&
                      l.range
                        .stop(1, 1)
                        [r ? "animate" : "css"]({ left: i + "%" }, h.animate),
                    1 === e &&
                  ...
                  : (0 === e &&
                      l.range
                        .stop(1, 1)
                        [r ? "animate" : "css"]({ bottom: i + "%" }, h.animate),
                    1 === e &&
                      l.range[r ? "animate" : "css"](
                        { height: i - t + "%" },
                        { queue: !1, duration: h.animate },
        ...
        : ((e = this.value()),
          ...
          "max" === n &&
            ...
            this.range
              .stop(1, 1)
              [r ? "animate" : "css"]({ width: 100 - i + "%" }, h.animate),
          "min" === n &&
          ...
          "max" === n &&
            ...
            this.range
              .stop(1, 1)
              [r ? "animate" : "css"]({ height: 100 - i + "%" }, h.animate));
    },
    _handleEvents: {
      keydown: function (e) {
        var t,
